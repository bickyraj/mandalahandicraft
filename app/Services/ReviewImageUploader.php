...
class ReviewImageUploader extends AbstractImageUploader
{
    const FULL_IMG_FOLDER = "/uploads/reviews/full/";

    const THUMB_IMG_FOLDER = "/uploads/reviews/thumb/";

    const CROP_IMG_FOLDER = "/uploads/reviews/crop/";

    const SMALL_IMG_FOLDER = "/uploads/reviews/small/";

    const MODIFIED_FOLDER = "/uploads/reviews/modified/";

    const MOBILE_FOLDER = "/uploads/reviews/mobile/";
