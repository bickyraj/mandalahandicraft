...
class SliderImageUploader extends AbstractImageUploader
{
    const FULL_IMG_FOLDER = "/uploads/sliders/full/";

    const THUMB_IMG_FOLDER = "/uploads/sliders/thumb/";

    const CROP_IMG_FOLDER = "/uploads/sliders/crop/";

    const SMALL_IMG_FOLDER = "/uploads/sliders/small/";

    const MODIFIED_FOLDER = "/uploads/sliders/modified/";

    const MOBILE_FOLDER = "/uploads/sliders/mobile/";
