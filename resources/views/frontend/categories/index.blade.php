    ...
    <div class="holder mt-0">
        <div class="container">
            <ul class="breadcrumbs">
                ...
                <li><a href="{{ url('category') }}/{{ $categorySlug }}">{{ucwords($category_name)}}</a></li>
            </ul>
        </div>
    </div>
    <div class="holder mt-0">
...
@push('script')
    <script>
        ...
        function loadProduct() {
            ...
            let url = "{{ url('load-category') }}?page="+page;
            let data = {price_min: price_min, price_max: price_max, _token:token,
                brand_id:brand_id, color_id:color_id, featured:featured, sale:sale, popular:popular, limit:limit, price_order: price_order,
