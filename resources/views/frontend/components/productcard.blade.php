...
<div class="product-card border-light hover:border-secondary relative">
    ...
    <a href="{{ route('products.show') }}" class="block product-card-image">
    ...
    <div class="p-4 text-center">
        <h3 class="mb-4 font-bold text-lg text-dark truncate">
            <a href="{{ route('products.show') }}">{{ $product->name }}</a>
        </h3>
        <div class="mb-4">
        ...
        <div class="mb-6">
            ...
            <span class="text-lg text-dark">${{ number_format($product->price) }}</span>
        </div>
