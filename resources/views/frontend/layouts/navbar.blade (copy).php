...
{{--                <!-- /Menu Toggle -->--}}
{{--                <div class="logo-holder"><a href="{{ url('') }}" class="logo"><img src="{{ $company->logo() }}" srcset="{{ url('') }}/frontend/images/logo-retina.png 2x" alt=""></a></div>--}}
...
{{--                                <div class="container">--}}
{{--                                    <form action="#" class="search"><button type="submit" class="search-button"><i class="icon-search2"></i></button>--}}
{{--                                        <input type="text" class="search-input" placeholder="search keyword" style="width: 80%">--}}
...
{{--                                    <ul>--}}
{{--                                        @if(auth()->check() && auth()->user()->hasRole('normal'))--}}
{{--                                        <li>--}}
...
{{--            <div class="container">--}}
{{--                <div class="row">--}}
{{--                    <div class="col-auto logo-holder"><a href="{{ url('') }}" class="logo"><img src="{{ $company->logo() }}" srcset="{{ url('') }}/frontend/images/logo-retina.png 2x" alt=""></a></div>--}}
{{--                    <!--navigation-->--}}
...
{{--                                                <img src="{{$item->options->firstImage}}" data-srcset="{{$item->options->firstImage}}" class="lazyload" alt=""></a>--}}
{{--                                            </div>--}}
...
{{--                                                <div class="minicart-drop-btns-wrap"><a href="{{route('checkout')}}" class="btn"><i class="icon-check-box"></i><span>checkout</span></a> <a href="cart.html" class="btn btn--alt"><i class="icon-handbag"></i><span>view cart</span></a></div>--}}
{{--                                            </div>--}}
...
{{--                <div class="col-auto logo-holder-s"><a href="index.html" class="logo"><img src="{{ $company->logo() }}" srcset="{{ url('') }}/frontend/images/logo-retina.png 2x" alt=""></a></div>--}}
{{--                <!--navigation-->--}}
{{--                <div class="prev-menu-scroll icon-angle-left prev-menu-js"></div>--}}
