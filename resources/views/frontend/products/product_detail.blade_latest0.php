                            ...
                            <div class="prd-block_main-image-holder js-main-image-zoom" data-zoomtype="inner">
                                ...
                                <div class="prd-has-loader">
                                    ...
                                    <img id="productPreviewImage" src=""
                                         class="zoom" alt="" data-zoom-image="">
                                </div>
                                <div class="prd-block_main-image-next slick-next js-main-image-next">NEXT</div>
                                <div class="prd-block_main-image-prev slick-prev js-main-image-prev">PREV</div>
                            </div>
                            <div class="prd-block_main-image-links">
{{--                                <a data-fancybox data-width="900" href="https://www.youtube.com/watch?v=Zk3kr7J_v3Q" class="prd-block_video-link"><i class="icon icon-play"></i></a> --}}
                            ...
                            <div class="color-product-images" style="display: none;">
                                @if(isset($product->images) && $product->images->count())
                                    @foreach($product->images as $image)
                                        <div class="color-product-images-0">
                                ...
                                @if($product->hasColor())
                                    <div class="prd-color swatches"><span class="option-label">Color:</span>
                                        ...
                                        <ul class="color-list color-list--sm">
                                            @if(isset($product->colors) && $product->colors->count())
                                                @foreach($product->colors as $color)
                                                    <li class="@if ($loop->first) active @endif"><a href="#" data-toggle="tooltip" data-placement="top" title="{{ $color->name }}" data-value="{{ $color->id }}" data-image="{{ $color->modified_image() }}"><span class="value"><img style="height: 92%; max-height: 50px" src="{{ $color->modified_image() }}" alt=""></span></a></li>
                                                @endforeach
                                            @endif
                                        </ul>
                                    </div>
