      ...
      <div class="card-content">
        ...
        <div class="row">
          ...
          <div class="col-md-2">
            {{--image--}}
            @if($edit)
              @include('extras.input_image', ['input_image'=>$news->modified_image()])
            @else
        ...
        <div class="form-footer text-right">
           <a href="{{route('news.index')}}" class="btn btn-default"><i class="fa fa-arrow-circle-left"></i> Back</a>
