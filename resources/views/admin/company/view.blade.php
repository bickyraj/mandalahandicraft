    ...
    <div class="card">
      ...
      <div class="card-content">
        ...
        <div class="row">
          <div class="col-md-2">
            {{--logo--}}
            @include('extras.input_image', ['input_image'=>$company->logo(),'image_name_field'=>'logo'])
          </div>
          <div class="col-md-10">
            {{--name--}}
            ...
            <div class="row">
              <div class="col-md-6">
                {{--facebook_url--}}
                <div class="form-group" {{ $errors->has('youtube')?'has-error is-focused':'' }}>
                  <label for="youtube">{{ ucwords('youtube url') }}</label>
                  <input type="url"
                         class="form-control"
                         id="youtube"
                         name="youtube"
              ...
              <div class="col-md-6">
                {{--twitter_url--}}
                <div class="form-group" {{ $errors->has('instagram')?'has-error is-focused':'' }}>
                  <label for="instagram">{{ ucwords('instagram url') }}</label>
                  <input type="url"
                         class="form-control"
                         id="instagram"
                         name="instagram"
            ...
            {{--promo_title--}}
            <div class="form-group" {{ $errors->has('offer')?'has-error is-focused':'' }}>
              <label for="instagram">{{ ucwords('Promo Title') }}</label>
              <input type="text"
                     class="form-control"
                     id="offer"
                     name="offer"
            ...
            <div class="form-group">
              ...
              <textarea class="form-control asdh-tinymce"
                        ...
                        rows="10">{{$company->terms_condition}}</textarea>
            </div>
