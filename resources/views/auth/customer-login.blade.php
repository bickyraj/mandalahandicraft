...
{{--                                    <a href="{{route('facebookLogin')}}" class="btn btn-primary btn-lg btn-block"><i class="fa fa-facebook"></i> Sign in with <b>Facebook</b></a>--}}
{{--                                    --}}
{{--                                    <a href="{{route('googleLogin')}}" class="btn btn-danger btn-lg btn-block"><i class="fa fa-google"></i> Sign in with <b>Google</b></a>--}}
{{--                                </div>--}}
